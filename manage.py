...
Usage:
    manage.py (drive) [--model=<model>] [--js] [--type=(linear|categorical|rnn|imu|behavior|3d|localizer|latent)] [--camera=(single|stereo)] [--meta=<key:value> ...] [--myconfig=<filename>] [--debug]
...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[], debug=False):
    '''
    ...
    if use_joystick or cfg.USE_JOYSTICK_AS_DEFAULT:
        ...
        if cfg.HAVE_ROBOHAT:
            ...
            ctr = get_js_controller(cfg, debug=debug)
...
if __name__ == '__main__':
    ...
    if args['drive']:
        ...
        drive(cfg, model_path=args['--model'], use_joystick=args['--js'],
              ...
              meta=args['--meta'], debug=args['--debug'])
